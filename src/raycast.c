...
/*   Updated: 2024/08/13 10:08:30 by dlanzas-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
void get_ray_posdir(t_game *game, int x)
{
	t_raycast	*r;
    t_player    *p;
...
*/
void get_walldistance(t_game *game)
{
	t_raycast	*r;
    t_player    *p;
...
*/
void get_wallheight(t_game *game)
{
	t_raycast	*r;
    t_player    *p;
...
*/
void get_ray_step_sidedist(t_game *game)
{
	t_raycast	*r;
    t_player    *p;
